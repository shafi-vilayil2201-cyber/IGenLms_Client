...
import { GraduationCap, Flame, Trophy, BookOpen, CheckCircle, Star, ChevronDown, ChevronRight, ArrowRight, Lock } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button onClick={() => navigate("/login")} data-testid="button-hero-mentors"
